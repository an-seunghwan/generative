...
if PARAMS['data'] == "cifar10":
    ...
    assert 0 == 1
#%%
model = ncsn_models_v1.build_refinenet(PARAMS, activation=tf.nn.elu)
...
plt.close()
#%%
model.save_weights('./assets/{}/weights_v1_{}_{}_{}_{}_{}/weights'.format(PARAMS['data'],
                                                                        PARAMS['data'], 
                                                                        PARAMS['learning_rate'], 
                                                                        PARAMS['num_L'],
                                                                        PARAMS['sigma_high'],
...
# model.load_weights('./assets/{}/weights_v1_{}_{}_{}_{}_{}/weights'.format(PARAMS['data'], 
                                                                        # PARAMS['data'],
                                                                        # PARAMS['learning_rate'], 
                                                                        # PARAMS['num_L'],
                                                                        # PARAMS['sigma_high'],
