...
from modules import models_v1_modified
#%%
PARAMS = {
    "batch_size": 128,
    "epochs": 200000, 
...
if PARAMS['data'] == "cifar10":
    ...
    assert 0 == 1
#%%
model = models_v1_modified.build_unet(PARAMS, PARAMS['embedding_dim'], dropout=0., embedding_dim_mult=(1, 2, 4, 8), num_res_blocks=2, attn_resolutions=(16, ), resamp_with_conv=True)
...
ax.set_title('loss')
plt.savefig('./assets/loss_v1_modified_{}_{}_{}_{}_{}.png'.format(PARAMS['data'], 
...
plt.close()
#%%
model.save_weights('./assets/{}/weights_v1_modified_{}_{}_{}_{}_{}/weights'.format(PARAMS['data'],
                                                                                PARAMS['data'], 
                                                                                PARAMS['learning_rate'], 
                                                                                PARAMS['embedding_dim'],
                                                                                PARAMS['num_L'],
...
#%%
# model = models_v1_modified.build_unet(PARAMS, PARAMS['embedding_dim'], dropout=0., embedding_dim_mult=(1, 2, 4, 8), num_res_blocks=2, attn_resolutions=(16, ), resamp_with_conv=True)
# model.load_weights('./assets/{}/weights_v1_modified_{}_{}_{}_{}_{}_{}/weights'.format(PARAMS['data'], 
#                                                                                     PARAMS['data'],
#                                                                                     PARAMS['learning_rate'], 
#                                                                                     PARAMS['embedding_dim'],
#                                                                                     PARAMS['num_L'],
